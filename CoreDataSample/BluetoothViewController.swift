...
class BluetoothViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let url = URL(string: "https://172.20.10.6:3003") {
...
extension BluetoothViewController: WKUIDelegate {
